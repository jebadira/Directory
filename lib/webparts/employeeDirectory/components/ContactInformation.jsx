        ...
        return (<div className={css(styles.ContactContainer)}>
                    <table className={css(styles.ContactTable)}>
                        <tr>
                            ...
                            <td>{this.props.user.get('phoneNumber')}</td>
                        </tr>
                        <tr className={css(styles.tablePicture)}>
                            <td><Mail color={ASUColors.ASUMaroon} /></td>
                            <td>{this.props.user.get('email')}</td>
                        </tr>
                        <tr>
                            <td className={css(styles.tablePicture)}>
                                <Business  color={ASUColors.ASUMaroon}/>
                            </td>
                            <td>{this.props.user.get('secondNumber')}</td>
                        </tr>
                    </table>
                </div>);
    }
